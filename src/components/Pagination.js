...
const Pagination = ({pages, setCurrentPage, currentLinks, sortedLinks}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentLinks.length}</b> out of <b>{sortedLinks.length}</b> entries</div>
